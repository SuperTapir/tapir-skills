...
When a deck needs an original illustration, follow the bundled [illustration rules](illustration-rules.md) and their machine-readable sibling `illustration-rules.json`. Generated illustrations stay deck-local by default; do not promote them into the shared registry merely because one slide looks good.
